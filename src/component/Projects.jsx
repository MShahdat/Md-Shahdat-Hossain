...
const project = [
  {
    cover: <IoSchoolSharp className='text-ternaryColor/80'/>,
    ...
    bgcolor: 'bg-primaryColor/20',
  },
  {
    cover: <FaPix className='text-primaryColor/90'/>,
    ...
    bgcolor: 'bg-secondaryColor/5',
  },
  {
    cover: <MdRealEstateAgent className='text-secondaryColor/80'/>,
  ...
  {
    cover: <IoRestaurantSharp className='text-primaryColor/90'/>,
  ...
  {
    cover: <GiSchoolBag className='text-ternaryColor/80'/>,
    ...
    bgcolor: 'bg-ternaryColor/5',
  },
  {
    cover: <IoLibrary className='text-purple-500'/>,
...
const Projects = () => {
  ...
  return (
    <div id='projects' className='bg-[#010109] text-white'>
