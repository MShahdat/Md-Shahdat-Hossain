      ...
      <div className='max-w-7xl px-4 py-16 mx-auto'>
        <div>
          ...
          <Marquee
            ...
            play={true}
          >
            <div className='py-10 mx-auto flex justify-between gap-12 md:gap-20'>
              {
                tool.map((item, idx) => {
                  return (
                    <div key={idx} className={`flex flex-col items-center gap-2`}>
                      <span className="w-8 md:w-10 lg:w-12  h-8 md:h-10 lg:h-12">
                        {item.icon}
                      </span>
                      <p className='md:font-medium text-[14px] md:text-[16px]'>{item.label}</p>
                    </div>
                  )
                })
              }
